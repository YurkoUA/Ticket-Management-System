...
namespace TicketManagementSystem.Domain.Util
{
    public class DomainModule : NinjectModule
    {
        ...
        public override void Load()
        {
            ...
            Bind<ICommandHandlerAsync<ChangeNumberCommand, CommandResultVM<object>>>().To<ChangeNumberCH>();
            Bind<ICommandHandlerAsync<MoveTicketCommand, CommandResultVM<object>>>().To<MoveTicketCH>();
